...
HD_PWD='/home/magnus/dokumenter/design-av-digitale-system-1/rsa_encoding/rsa_encoding.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RSACoreTestBench.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RSACoreTestBench.tcl -notrace
