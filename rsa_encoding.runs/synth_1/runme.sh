...
HD_PWD='/home/magnus/dokumenter/design-av-digitale-system-1/rsa_encoding/rsa_encoding.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RSACoreTestBench.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RSACoreTestBench.tcl
